...
This example use Max-Margin (MMOD) CNN face detector.
This example requires the pre-trained model 'mmod_human_face_detector.dat'
...
while (capture.isOpened()):
    ...
    cv2.imshow('Face Detector CNN', image)
    if (cv2.waitKey(1) == 27):
        break
